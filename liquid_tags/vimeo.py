...
def vimeo(preprocessor, tag, markup):
    ...
    if vimeo_id:
        vimeo_out = "<div class='videoWrapper'><iframe src='//player.vimeo.com/video/{vimeo_id}?title=0&amp;byline=0&amp;portrait=0' width='{width}' height='{height}' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>".format(width=width, height=height, vimeo_id=vimeo_id)
    else:

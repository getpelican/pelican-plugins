...
# Do not use a leading or trailing slash below (e.g., use "images/youtube-thumbnails"):
output_directory_for_thumbnails = "images/youtube-thumbnails"
...
1. Enable the plugn in pelicanconf.py (see http://docs.getpelican.com/en/3.3.0/plugins.html for documentation):  
    ...
    PLUGINS = ["youtube_privacy_enhancer"]
...
2b. Copy the jQuery file in this folder into, for example, your_theme_folder/static/youtube_privacy_enhancer_jQuery.js, and add a line like this to the <head></head> element of your website's base.html (or equivalent) template:
    `<script src="{{ SITEURL }}/theme/youtube_privacy_enhancer_jquery.js"></script> <!--Load jQuery functions for the Youtube Privacy Enhancer Pelican plugin -->`
...
```
/* For use with the youtube-privacy-enhancer Pelican plugin */
img.youtube-embed-dummy-image.
...
# A function to download the video thumbnail from YouTube:
